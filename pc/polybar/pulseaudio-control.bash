...
MUTED_COLOR="%{F#c77060}"  # Color when the audio is muted
...
SINK_NICKNAMES["alsa_output.usb-SteelSeries_SteelSeries_Arctis_1_Wireless-00.analog-stereo"]=" Arctis 1"
SINK_NICKNAMES["alsa_output.pci-0000_00_1b.0.analog-stereo"]=" Speakers"
...
function output() {
    ...
    if [ "$isMuted" = "yes" ]; then
        echo "| ${SINK_ICON}${nickname}${END_COLOR} ${MUTED_COLOR}${MUTED_ICON}${curVol}%" 
    else
        echo "| ${SINK_ICON}${nickname} ${volIcon}${curVol}%"
    fi
}
